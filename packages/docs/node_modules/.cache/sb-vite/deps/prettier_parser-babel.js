...
var require_babel = __commonJS({
  "../../node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var Ft = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), si = (a, t) => {
        for (var e in t)
          Ee(a, e, { get: t[e], enumerable: true });
      }, Bt = (a, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of Zs(t))
            !ti.call(a, i) && i !== e && Ee(a, i, { get: () => t[i], enumerable: !(s = Qs(t, i)) || s.enumerable });
        return a;
      };
      var qe = (a, t, e) => (e = a != null ? Ys(ei(a)) : {}, Bt(t || !a || !a.__esModule ? Ee(e, "default", { value: a, enumerable: true }) : e, a)), ii = (a) => Bt(Ee({}, "__esModule", { value: true }), a);
      var kt = Ft((_e) => {
        "use strict";
        function De(a, t) {
          if (a == null)
...
`);
        ...
        function ns(a, t, e, s, i, r, n, o, h, l) {
          ...
          for (let I = 0, C = r ?? 1 / 0; I < C; ++I) {
            ...
            if (E === 95 && o !== "bail") {
              let Ce = a.charCodeAt(t - 1), ce = a.charCodeAt(t + 1);
              if (o) {
                if (Number.isNaN(ce) || !f(ce) || u.has(Ce) || u.has(ce)) {
                  if (l)
                    return { n: null, pos: t };
        ...
        var tr = /\*?\s*@((?:no)?flow)\b/, sr = (a) => class extends a {
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), l = 9, c = true) : (this.expect(5), l = 8, c = false), h.exact = c; !this.match(l); ) {
              ...
              if (this.eat(0))
                ...
                let Ce = this.flowParseObjectTypeProperty(C, d, x, E, N, i, n ?? !c);
                Ce === null ? (u = true, I = this.state.lastTokStartLoc) : h.properties.push(Ce);
              }
          ...
          flowEnumErrorStringMemberInconsistentlyInitialized(e, { enumName: s }) {
            this.raise(g.EnumStringMemberInconsistentlyInitialized, { at: e, enumName: s });
          }
          flowEnumMemberInit() {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
        ...
        var xt = class extends yt {
          ...
          parseCoverCallAndAsyncArrowHead(t, e, s, i) {
            ...
            h && (this.expressionScope.enter(Ji()), n = new se()), l && (o.optional = i), i ? o.arguments = this.parseCallExpressionArguments(11) : o.arguments = this.parseCallExpressionArguments(11, t.type === "Import", t.type !== "Super", h ? o : null, n);
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
      ...
      function Hr(a) {
        ...
        return $e(t.replace(/ \(.*\)$/, ""), { loc: { start: { line: e ? e.line : 0, column: e ? e.column + 1 : 0 } }, cause: a });
      }
      var be = Hr;
      var Wr = (a, t, e) => {
        if (!(a && t == null))
      ...
      var vs = Jr;
      var Xr = vs(["Block", "CommentBlock", "MultiLine"]), Ae = Xr;
      function Gr(a) {
        return Ae(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/.test(a.value);
      }
      var Ls = Gr;
      function Yr(a) {
        let t = `*${a.value}*`.split(`
`);
      ...
      function we(a) {
        if (Se !== null && typeof Se.property) {
          let t = Se;
          return Se = we.prototype = null, t;
        }
        return Se = we.prototype = a ?? /* @__PURE__ */ Object.create(null), new we();
      }
      var Qr = 10;
      for (let a = 0; a <= Qr; a++)
        we();
      ...
      function ta(a, t) {
        ...
        if (a = Ve(a, (r) => {
          ...
          for (let n = a.comments.length - 2; n >= 0; n--) {
            let o = a.comments[n];
            B(o) === D(r) && Ae(o) && Ae(r) && Lt(o) && Lt(r) && (a.comments.splice(n + 1, 1), o.value += "*//*" + r.value, o.range = [D(o), B(r)]), r = o;
          }
        }
      ...
      function la({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          ...
          let o = a ? Ke.parseExpression : Ke.parse, h;
          try {
            h = ms(i.map((l) => () => ha(o, e, l)));
          } catch ({ errors: [l] }) {
            throw be(l);
          }
          return a && (h = ze(h, { text: e, rootMarker: s.rootMarker })), Bs(h, { parser: "babel", text: e });
        };
      }
      ...
      function Xs(a = {}) {
        ...
        return function(s) {
          ...
          try {
            ...
            throw (r == null ? void 0 : r.reasonCode) === "MissingPlugin" || (r == null ? void 0 : r.reasonCode) === "MissingOneOfPlugins" ? be({ message: "Unexpected token", loc: r.loc }) : be(r);
          }
          if (!t && Y(i.comments))
            throw H(i.comments[0], "Comment");
          return le(i), ze(i, { type: "JsonRoot", text: s });
        };
      }
      function H(a, t) {
        let [e, s] = [a.loc.start, a.loc.end].map(({ line: i, column: r }) => ({ line: i, column: r + 1 }));
        return $e(`${t} is not allowed in JSON.`, { loc: { start: e, end: s } });
      }
      function le(a) {
        switch (a.type) {
          case "ArrayExpression":
